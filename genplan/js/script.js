...
$(document).ready(function () {
  ...
  function outputOrderMessageHouse(area, houseNum, levelNum) {
    var markupText = 'Меня интересует дом типа ' + houseNum + ' общей площадью ' + area + 'м².';
    return markupText;
  }
  ...
  document.querySelector('.js-image-print').addEventListener('click', printImage);

  function printImage(event) {
    event.preventDefault();

    var imagePath = this.href;
    var imageWin = window.open(imagePath, 'image-win');
